...
for (i in 1: length(anos)){
        ...
        export(indsegtg, here("../1_Data/processed/",linkage_tg))
        export(indsegtm, here("../1_Data/processed/",linkage_tm))
        export(indsegtf, here("../1_Data/processed/",linkage_tf))
        ...
        export(indseg, here("../1_Data/processed/",linkage_g))
        export(indseg2, here("../1_Data/processed/",linkage_m))
        export(indseg3, here("../1_Data/processed/",linkage_f))
        
        
        rm(c)
        
        export(curso, here("../1_Data/processed/",file_to_save_i))
...
for (i in 1: length(anos))
{
        ...
        export(part, here("../1_Data/processed/", part_geral))
        ...
        export(part_s, here("../1_Data/processed/",part_sexo))
        ...
        export(peduc, here("../1_Data/processed/", part_educ))
        ...
        export(parea,here("../1_Data/processed/", part_area))
        ...
        export(plf, here("../1_Data/processed/", part_lf))
        ...
        export(plfs, here("../1_Data/processed/", part_lfs))
        
        export(c,  here("../1_Data/processed/",file_to_save_i))
