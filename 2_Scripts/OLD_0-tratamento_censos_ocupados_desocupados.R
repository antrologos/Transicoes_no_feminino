...
# dados de ocupados somente - importar de pasta raw, só que ocupados
wd = "C:\\Users\\demed\\Dropbox\\PC\\Documents\\Carol\\Dissertação\\Pesquisa\\Dissertacao_CarolinaMedeiros\\1_Data"

#dados de desocupados também (para taxas de participação) - importar de pasta raw, só que com desocupados
wd2 = "C:\\Users\\demed\\Dropbox\\PC\\Documents\\Carol\\Dissertação\\Pesquisa\\Dissertacao_CarolinaMedeiros\\1_Data\\censo com desocupados"

# exportar pra pasta de bancos processed 
wd3 = "C:\\Users\\demed\\Dropbox\\PC\\Documents\\Carol\\Dissertação\\Pesquisa\\Dissertacao_CarolinaMedeiros\\1_Data\\levelfield"
...
for (i in 1: length(anos))
{
  ...
  export(curso, paste0(wd3, arquivo))
...
for (i in 1: length(anos))
{
  ...
  arquivo_i = paste0("\\Census_", ano_i, "_Harmonized_AllVariables.fst", sep = "")
  arquivo = paste0("\\censodesocup", ano_i, ".fst", sep = "") # 
  
  
  c = import(paste0(wd2, arquivo_i))
